...
namespace Tako.Collections.Generic
{
    public class MinHeap<T> : ICollection<T>
    {
        ...
        public MinHeap()
            : this(null, MinHeap<T>.defaultCount, false, null)
        {
        }

        public MinHeap(IComparer<T> comparer)
            : this(null, MinHeap<T>.defaultCount, false, comparer)
        {
        }

        public MinHeap(T[] array, bool doesCopy)
            : this(array, array.Length, doesCopy, null)
        {
        }

        public MinHeap(T[] array, int size, bool doesCopy, IComparer<T> comparer)
        {
            if (size <= 0)
            {
        ...
        private void Heapify(int index)
        {
            ...
            {
                if (0 < this.Comparer.Compare(this.array[smallestIndex], this.array[leftIndex]))
                {
                ...
                {
                    if (0 < this.Comparer.Compare(this.array[smallestIndex], this.array[rightIndex]))
                    {
        ...
        private void ShiftUp(int index)
        {
            ...
            if (this.Comparer.Compare(this.array[index], this.array[parentIndex]) < 0)
            {
                T temp = this.array[index];
